...
urlpatterns = [
    ...
    path("message_form/<int:pk>/", MessageUpdateView.as_view(), name="message_update"),  # Форма редактирования сообщения
    path("message_confirm_delete/<int:pk>/delete/", MessageDeleteView.as_view(), name="message_delete"),  # Форма удаления сообщения
]
